...
Now is easier than ever to use **mbed** library offline with eclipse and GNU ARM. In this repository you will find a eclipse project with mbed library for ST [**NucleoF103RB**](http://developer.mbed.org/platforms/ST-Nucleo-F103RB/) board.
...
**https://github.com/Hotboards/mbed_NucleoF103RB.git**
